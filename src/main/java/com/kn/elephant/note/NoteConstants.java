...
public class NoteConstants {
    ...
    public static final String FOLDER_APP = ".noteFx-dev";
    ...
    public static final int MAX_SIZE_CACHE = 100000; //100K
    ...
    public static String INIT_NOTE_CONTENT = "<!DOCTYPE html> <html> <head>"  + TABLE_CSS + "</head> <body><div contenteditable=true id=\"noteFx\"></div> </body> </html>";
